...
roof.append(layer(thickness=0.27,cc=CC,components=[isoCell,studs]))
roof.append(layer(thickness=0.05,cc=CC,components=[pevatherm]))
roof.append(layer(thickness=0.045,cc=CC,components=[studs,luftspalt],insulation=False))
...
energyFlux = CpAir*airFlux*avgDeltaT
vPipeDiameter = 0.16
